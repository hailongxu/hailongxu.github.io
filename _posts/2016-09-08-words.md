...
Mass car ownership clearly has a number of undersirable consequences for people's health and fitness as well as for the enviroment and community life generally. Nevertheless, owning a car is still seen as a desirable option to many. Although this trend might seem irreversible so far, there is much that can be done to discourage unnecessary car use.
